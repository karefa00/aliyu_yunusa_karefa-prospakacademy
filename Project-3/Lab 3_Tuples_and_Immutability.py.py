...
print("Attempting to modify a tuple results in TypeError (tuples are immutable).")
...
print(f"Returned dimensions (tuple): {dimensions}")

my_length, my_width = dimensions
print(f"Unpacked length: {my_length}")
print(f"Unpacked width: {my_width}")
print(f"Area: {my_length * my_width}")

print("-" * 30)


# 5. Tuples Within a List
cities = []
